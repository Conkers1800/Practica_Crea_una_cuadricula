...
fun CuadriculaTema(modifier: Modifier = Modifier) {
    LazyVerticalGrid(
        ...
        items(DataSource.topics) { cuadricula -> CuadriculaNotificacion(cuadricula)
        }
    }
}
@Composable
fun CuadriculaNotificacion(cuadricula: Cuadricula, modifier: Modifier = Modifier) {
    Card {
        Row {
            Box {
                Image(
            ...
            Column {
                Text(
                    text = stringResource(id = cuadricula.nombre),
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Text(
                        text = cuadricula.cursosD.toString(),
